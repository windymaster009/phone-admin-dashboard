...
export function printInventoryLabels(items: LabelItem[]) {
  ...
  popup.document.write(`<!doctype html><html><head><title>PhoneFlow barcode labels</title><style>
    @page{size:80mm 50mm;margin:3mm}*{box-sizing:border-box}body{margin:0;background:#fff;color:#05070c;font-family:Arial,sans-serif}
    .label{width:74mm;height:44mm;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;overflow:hidden;break-after:page;page-break-after:always}.label:last-child{break-after:auto;page-break-after:auto}
    h1{max-width:72mm;margin:0 0 1mm;font-size:12pt;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.meta{margin:0 0 1mm;font-size:7.5pt}.price{margin:0;font-size:11pt;font-weight:800}.scan-value{margin:.5mm 0 1mm;font:700 7pt ui-monospace,Consolas,monospace;letter-spacing:.2pt}
    .barcode-box{width:72mm;display:flex;justify-content:center;overflow:hidden}svg{width:72mm;max-width:72mm;height:auto}@media screen{body{padding:20px}.label{margin:0 auto 20px;border:1px dashed #aaa}}
