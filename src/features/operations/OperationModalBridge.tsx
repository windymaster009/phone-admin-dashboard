          ...
          <div className="purchase-step-content">
            ...
            <section className="purchase-section-card pawn-terms-card">
              ...
              <div className="pawn-contract-summary">
                ...
                <div className="daily-fee-summary"><span>Daily pawn fee</span><strong>{pawnEffectiveDailyFeeRate.toLocaleString(undefined, { maximumFractionDigits: 4 })}% / day · {pawnAmountText(pawnDailyFeeAmount, pawnCurrency)} / day</strong></div>
