...
const inventoryItemSchema = new Schema(
  {
    ...
    pricingCurrency: { type: String, enum: ['USD', 'KHR'], default: 'USD' },
...
const paymentSchema = new Schema(
  {
    ...
    interestApplied: { type: Number, min: 0, default: 0 },
    pawnFeeApplied: { type: Number, min: 0, default: 0 },
    feesApplied: { type: Number, min: 0, default: 0 },
    principalApplied: { type: Number, min: 0, default: 0 },
    additionalCollected: { type: Number, min: 0, default: 0 },
...
const renewalSchema = new Schema(
  {
    ...
    interestCharged: { type: Number, min: 0, default: 0 },
    feePaid: { type: Number, min: 0, default: 0 },
    principalRemaining: { type: Number, min: 0 },
    termDays: { type: Number, enum: [3, 7, 15, 30] },
    contractLengthDays: { type: Number, min: 0 },
    dailyFeeRate: { type: Number, min: 0, max: 100 },
    dailyFeeAmount: { type: Number, min: 0 },
    ticketPart: { type: Number, min: 2 },
...
const pawnSchema = new Schema(
  {
    ...
    valuationSnapshot: {
      ...
      pawnPercentage: { type: Number, min: 40, max: 50 },
      ageDeduction: { type: Number, min: 0 },
      conditionDeduction: { type: Number, min: 0 },
      batteryDeduction: { type: Number, min: 0 },
      accessoryDeduction: { type: Number, min: 0 },
      carrierLockDeduction: { type: Number, min: 0 },
      estimatedValue: { type: Number, min: 0 },
      maximumPawn: { type: Number, min: 0 },
    },
    principal: { type: Number, min: 0, required: true },
    originalPrincipal: { type: Number, min: 0, required: true },
    remainingPrincipal: { type: Number, min: 0, required: true },
    ...
    feeAccrualStartedAt: Date,
    accruedPawnFee: { type: Number, min: 0, default: 0 },
    pawnFeePaid: { type: Number, min: 0, default: 0 },
    ...
    redemptionAdditionalAmount: { type: Number, min: 0 },
    redeemedAt: Date,
    forfeitedAt: Date,
